...
public class Login extends javax.swing.JFrame {
    ...
    public void connect(){
        ...
        System.out.println("Login Page Connected to Database");
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("M-A-L-T");

        jLabel7.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(204, 204, 204));
        jLabel7.setText("copyright © M-A-L-T All rights reserved");
        ...
        UserEmail.setForeground(new java.awt.Color(102, 102, 102));
                    ...
                    .addGroup(LeftLayout.createSequentialGroup()
                        ...
                        .addGroup(LeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(LeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(UserPassword, javax.swing.GroupLayout.DEFAULT_SIZE, 343, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Find the user document with the entered email
        ...
        if (result.iterator().hasNext()) {
            ...
            if (password.equals(storedPassword)) {
                ...
                // Dispose the login page and navigate to the Home Page
                
                // Set the user's ObjectId and email in the session
                UserSession session = UserSession.getInstance();
                session.setUserEmail(email);
                session.setUserObjectId(userDoc.getObjectId("_id").toString());
